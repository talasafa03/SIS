...
public class StudentViewEnrolledCoursesToDrop extends Application{
	private int stdId;
    private Stage primaryStage;
	
	public StudentViewEnrolledCoursesToDrop(int stdId, Stage primaryStage) {
		this.stdId = stdId;
	...
	private void viewClasses() {
	    ...
	    for (ClassCourse classCrs : classes) {
	        ...
	        dropButton.setOnAction(e -> s.DropCourse(con, classCrs.getClassId(), l));

	        classBox.getChildren().addAll(classInfoLabel, dropButton, l);
